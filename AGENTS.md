# AGENTS.md — Memory Context for Smart Bookmarks Extension
...
- **AI Stack**:
  - Codex — for planning, reasoning, and all code writing
...
Codex is responsible for **all code generation and refactoring**, including:
...
## 📚 Gemini CLI Role (Complementary to Codex)

Gemini is used to:
- Summarize best practices (e.g. billing flows, pgvector)
- Log feature research
- Feed Codex memory by appending structured insights to this file

Always treat `AGENTS.md` as the **single source of truth** for project intent and system design. Codex should reason from this file.
...
- AI-enhanced tagging using Codex/MCP
...
### 3. ⚙️ MCP Integration
- Codex handles reasoning-heavy prompts
...
- ✅ Codex should write TypeScript only (never JavaScript)

---

## ✅ Codex Prompts Allowed
...
*Use `gemini -p "Summarize topic X" >> AGENTS.md` to append structured memory here*
